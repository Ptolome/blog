...
import { fetchAuth, fetchRegister, selectorIsAuth } from "../redux/slices/auth";
...
export const Registration = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!isValid) return;
    const info = await dispatch(fetchRegister(data));
    if (!info.payload) {
      return alert("Произошла ошибка! Вы не зарегистрированны!");
    }
